...
🏢 I have worked in systems development & tech area for over 18 years. Some of the well-known companies I worked for were Indra, Telecom, Globant, Disney, OLX, Letgo, Mercadolibre, Mercadopago, Paypal & Venmo.

🤓🏻 I'm currently working as Sr. iOS Mobile Engineer (Full Remote) for Latch company.

📱 For the last 10 years I have been fully dedicated to the development of iOS applications. I became really strong in iOS apps, especially in user experience interfaces and the end-to-end development of user-centered mobile products mixing UIKit & SwiftUI.

💳 I have +6 years of experience in the Fintech area, leading mobile cross-functional teams (iOS, Android, and Backend) to build first-class mobile payment solutions with a focus on KPIs and NPS.

I'm available to hear remote job offers for mobile lead positions or Sr. remote iOS developer.

---

## App Development Professional Experience
...
- Optimizing navigation management for an elevated user experience.
- Implementing the Stripe SDK payment processing, designing a seamless user experience for payment workflows, ensuring compliance with Stripe's API standards, and implementing secure transaction handling (PCI).
...
- Contributed extensively to open-source projects and internal components.
...
- Recent Searches and Saved Searches (CoreData / SQLite).
- New Home, Filters, Listing, and Search Manager.
- Enhanced User Profiles, Public Seller Profiles, and Friends in Common features.
- Implemented Proximity features with MapKit and Category Suggestion functionality.
- Developed new Search with Autocomplete.
- Strongly focused on Apple guidelines and UX.

---

### **Personal Side-Projects Apps**

You can find my personal side weekend projects apps in the following list:
[Stuny](https://apps.apple.com/ar/app/stuny/id1663920227)
[Ridit](https://apps.apple.com/ar/developer/juan-sanzone/id1217039561)
[Quanto](https://apps.apple.com/ar/app/quanto/id1673724683)
